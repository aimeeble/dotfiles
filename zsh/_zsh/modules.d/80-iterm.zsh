...
typeset -g ITERM_SHELL_INTEGRATION_INSTALLED
typeset -g ITERM2_SHOULD_DECORATE_PROMPT="1"

_aimee_iterm_init() {
  # No local iTerm2 helpers, no need to set up integration.
  if [[ ! -d "$HOME/.iterm2" ]]; then
    return
  fi

  # Always set-up the aliases.
  ...
  # Only do prompt integration stuff for interactive sessions.
...
module_add "iTerm2" _aimee_iterm_init
